...
const DomainManagement = () => {
  const features = [
    {
      ...
      description: 'Full control over DNS records - A, CNAME, MX, TXT, and more',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Domain Lock',
      description: 'Protect domains from unauthorized transfers with security locks',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'WHOIS Privacy',
      description: 'Hide personal information from public WHOIS database',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Update registrant, admin, and technical contact information',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Transfer domains in or out with simple authorization codes',
    },
  ];
  ...
  const managementTools = [
    {
      title: 'DNS Editor',
      description: 'Add, edit, or remove DNS records with our intuitive interface',
      icon: (
    ...
    },
    {
      ...
      description: 'Point your domain to any hosting provider with custom nameservers',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Redirect your domain to any URL with or without masking',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Create email forwards from your domain to any email address',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Create and manage unlimited subdomains for your domain',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Manage multiple domains simultaneously with bulk tools',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-lg mb-8">
              ...
              <span className="text-sm font-medium text-gray-700">Powerful Domain Control</span>
            </div>
            ...
            <p className="text-gray-600 text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed">
              Take full control of your domains with our comprehensive management tools. DNS editing, WHOIS privacy, forwarding, and more - all in one place.
            </p>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link to="/services/domain-registration">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
          ...
          <motion.div
            ...
            className="mb-20"
          >
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-12 shadow-xl border border-purple-100">
              <h2 className="text-3xl font-bold text-center mb-8">
                <span className="bg-gradient-to-r from-[#9a00ff] to-purple-600 text-transparent bg-clip-text">
                  Why Choose Our Domain Management?
                </span>
              </h2>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center text-white">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Intuitive control panel makes domain management easy for everyone</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">DNS changes propagate quickly across the internet</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Domain locking, 2FA, and audit logs protect your assets</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">24/7 assistance from domain management specialists</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
              Get started with our powerful domain management tools and take full control of your online presence.
            </p>
            <Link to="/signup">
              <motion.button
                whileHover={{ scale: 1.05 }}
