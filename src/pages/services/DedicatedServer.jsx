...
const DedicatedServer = () => {
  const features = [
    {
      ...
      description: 'Entire server resources dedicated exclusively to your applications',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Enterprise-grade hardware for ultimate speed and reliability',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Full root access and custom server configurations',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Hardware firewalls and DDoS protection included',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Multiple RAID Options',
      description: 'RAID 0, 1, 5, 10 configurations for data redundancy',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const plans = [
    {
      name: 'Ryzen 5 3600x Dedicated Server',
      price: '₹9,000.00',
      period: '/mo',
      description: 'High-performance AMD Ryzen server',
      popular: true,
      url: 'https://portal.flarelax.com/index.php/store/dedicated-server/ryzen-5-3600x-dedicated-server',
      features: [
        '64 DDR4 RAM',
        '6 cores/12 threads (Amd Ryzen 5 3600X)',
        '1 TB NVMe Storage',
        'Delhi IN Located',
        '5 TB Bandwidth',
    ...
    {
      name: 'Intel Xeon 2670v3 Dedicated Server',
      price: '₹7,000.00',
      period: '/mo',
      description: 'Enterprise Intel Xeon processor',
      url: 'https://portal.flarelax.com/index.php/store/dedicated-server/intel-xeon-2670v3-dedicated-server',
      features: [
        '64 DDR3 RAM',
        '6 cores/12 threads (Intel xeon 2670v3)',
        '1 TB NVMe Storage',
        'Delhi IN Located',
        '5 TB Bandwidth',
        '1 Dedicated IPv4 IP Config',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-lg mb-8">
              ...
              <span className="text-sm font-medium text-gray-700">Enterprise-Grade Dedicated Servers</span>
            </div>
            ...
            <p className="text-gray-600 text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed">
              Get maximum power and control with our dedicated servers. Perfect for enterprise applications, high-traffic websites, and mission-critical workloads.
            </p>
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
              Contact our sales team for custom server configurations tailored to your specific requirements.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Link to="/signup">
                <motion.button
