...
const Documentation = () => {
  const categories = [
    ...
    },
    {
      ...
      description: 'Comprehensive hosting tutorials',
      articles: [
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-lg mb-8">
              ...
              <span className="text-sm font-medium text-gray-700">Comprehensive Guides & Tutorials</span>
            </div>
            ...
            <p className="text-gray-600 text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed">
              Everything you need to know about our hosting services. Step-by-step guides, tutorials, and best practices to help you succeed.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {categories.map((category, idx) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold bg-gradient-to-r from-[#9a00ff] to-purple-600 text-transparent bg-clip-text mb-2">
                    {category.title}
                  </h3>
                  ...
                  <ul className="space-y-2">
                    {category.articles.map((article, i) => (
                      <li key={i}>
                        <a href="#" className="text-sm text-gray-700 hover:text-[#9a00ff] transition-colors flex items-center gap-2">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link to="/resources/knowledgebase">
                <motion.button
